...
def do_run():
  rootPath = os.getcwd()
  directoryPath = rootPath + os.sep + 'first_project' + os.sep + 'Debug'
  change_directory(directoryPath)
  os.system('FirstProject.exe')
  directoryPath = rootPath + os.sep + 'second_project' + os.sep + 'Debug'
  change_directory(directoryPath)
  os.system('SecondProject.exe')
